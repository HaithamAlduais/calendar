...
export const SCHEDULE_START = "2026-08-06" // بداية جديدة (الخميس ٦ أغسطس) — نسينا ما قبلها
const BLOCK_START = "2026-08-06" // نافذة التوليد: كتل ٢٨ يومًا من البداية الجديدة
