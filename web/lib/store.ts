...
export const SCHEDULE_START = "2026-08-07" // بداية جديدة (الجمعة ٧ أغسطس) — نسينا ما قبلها
const BLOCK_START = "2026-08-07" // نافذة التوليد: كتل ٢٨ يومًا من البداية الجديدة
